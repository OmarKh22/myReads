...
Of course, you are free to start this project from scratch if you wish! Just be sure to use [Create React App]
...
└── src
    ...
    ├── HonePage.js # This is the component that contain 3 shelf.
    ├── Shelf.js # This is the shelf component.
